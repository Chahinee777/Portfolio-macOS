    ...
    <>
      <section id="welcome" ref={welcomeContainerRef}>
        ...
        <div className="small-screen">
          <p className="text-white">Mobile version is still in progress. For the full experience, use a larger screen. </p>
          <br />
          <p className="text-gray-400 text-sm">Please visit this site on a desktop device</p>
        </div>
      </section>
